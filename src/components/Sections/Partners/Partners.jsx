...
const data = [
  ...
  },
  {
    ...
    content:
      "об'єднує групу торгово-промислових компаній різних сфер бізнесу - виробнитцва виробів, алкогольних напоїв, с/г продукції, митно-складських послуг, дистрибуції лікеро-горілчаних виробів, косметики, продуктів харчування, транспортних засобів.",
    image: img2,
  },
  {
    title: 'Компанія Світ IT',
    content:
      'понад десятків років займається проектами в галузі ІТ. Має велику кількість клієнтів і вендорів, з якими багато років є  партнерами. Працюють з багатьма галузями та індустріями.',
    image: img3,
  },
  {
    title: 'Підприємство ТОВ «Перший трубний завод»',
    content:
      'Має 2000 найменувань продукції.  Виробництво здійснюється на сучасному обладнанні, за новітніми технологіями.',
    image: img4,
  },
  {
    title: 'Extreme LTD',
    content:
      'Інжинірінгова компания, займаєтьс розробкою та впровадженням рішень з електропостачання та автоматизації для проектів енергетики, промисловості, нерухомості та будівництва.',
    image: img5,
  },
];
